...
const getAllStudents = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield student_schema_1.Student.find(whereConditions)
        ...
        .skip(skip)
        .limit(limit);
    const total = yield student_schema_1.Student.countDocuments(whereConditions);
    return {
        meta: {
            page,
            limit,
...
const updateStudent = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield student_schema_1.Student.findOne({ id });
    if (!isExist) {
    ...
    const result = yield student_schema_1.Student.findOneAndUpdate({ id }, updatedStudentData, {
        new: true,
    });
    return result;
});
const deleteStudent = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const student = yield student_schema_1.Student.findOneAndDelete({ id }, { session });
        if (!student) {
